...
let VenuePhotoController = exports.VenuePhotoController = class VenuePhotoController {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'All Venue_Photo' }),
    (0, common_1.Get)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Id Serach Venue_Photo' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Create Venue_Photo' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update Venue_Photo' }),
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_venue_photo_dto_1.UpdateVenuePhotoDto]),
    __metadata("design:returntype", Promise)
], VenuePhotoController.prototype, "update", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Delete Venue_Photo' }),
    (0, common_1.Delete)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], VenuePhotoController.prototype, "delete", null);
exports.VenuePhotoController = VenuePhotoController = __decorate([
    (0, common_1.Controller)('venue-photos'),
