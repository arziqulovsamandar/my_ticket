...
let SeatModule = exports.SeatModule = class SeatModule {
};
exports.SeatModule = SeatModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([seat_model_1.Seat, seat_type_model_1.SeatType, venue_model_1.Venue])],
