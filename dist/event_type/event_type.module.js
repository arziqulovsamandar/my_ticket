...
let EventTypeModule = exports.EventTypeModule = class EventTypeModule {
};
exports.EventTypeModule = EventTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([event_type_model_1.EventType, event_type_model_1.EventType])],
