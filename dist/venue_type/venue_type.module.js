...
let VenueTypeModule = exports.VenueTypeModule = class VenueTypeModule {
};
exports.VenueTypeModule = VenueTypeModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([venue_type_model_1.VenueType, venue_model_1.Venue])],
