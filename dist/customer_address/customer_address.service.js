...
const customer_address_model_1 = require("./models/customer_address.model");
let CustomerAddressService = exports.CustomerAddressService = class CustomerAddressService {
    constructor(customerAddressModel) {
    ...
    async update(id, updateCustomerAddressDto) {
...
exports.CustomerAddressService = CustomerAddressService = __decorate([
    ...
    __param(0, (0, sequelize_1.InjectModel)(customer_address_model_1.CustomerAddress)),
