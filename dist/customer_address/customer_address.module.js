...
let CustomerAddressModule = exports.CustomerAddressModule = class CustomerAddressModule {
};
exports.CustomerAddressModule = CustomerAddressModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([customer_address_model_1.CustomerAddress, customer_model_1.Customer])],
