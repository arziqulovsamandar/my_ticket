...
let CustomerCardService = exports.CustomerCardService = class CustomerCardService {
    constructor(customerCardModel) {
        this.customerCardModel = customerCardModel;
    }
    async findAll() {
...
exports.CustomerCardService = CustomerCardService = __decorate([
    ...
    __param(0, (0, sequelize_1.InjectModel)(customer_card_model_1.CustomerCard)),
