...
const customer_card_model_1 = require("./models/customer_card.model");
...
let CustomerCardModule = exports.CustomerCardModule = class CustomerCardModule {
};
exports.CustomerCardModule = CustomerCardModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([customer_card_model_1.CustomerCard, customer_model_1.Customer])],
        controllers: [customer_card_controller_1.CustomerCardController],
        providers: [customer_card_service_1.CustomerCardService],
        exports: [customer_card_service_1.CustomerCardService],
    })
], CustomerCardModule);
